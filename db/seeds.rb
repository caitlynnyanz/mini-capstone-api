...
Supplier.create(name: "Barnes and Noble Classics", email: "barnesandnoble@test.com", phone_number: "123654789")

Product.create!(name: "'Crime and Punishment' by Fyodor Dostoevsky", price: 18.99, description: "Crime and Punishment follows the mental anguish and moral dilemmas of Rodion Raskolnikov, an impoverished ex-student in Saint Petersburg..", supplier_id: 1)

Product.create!(name: "'War and Peace' by Leo Tolstoy", price: 21.99, description: "War and Peace chronicles the French invasion of Russia and the impact of the Napoleonic era on Tsarist society through the stories of five Russian aristocratic families..", supplier_id: 2)

Product.create!(name: "'Wuthering Heights' by Emily Bronte", price: 17.99, description: "Wuthering Heights concerns two families of the landed gentry living on the West Yorkshire moors, the Earnshaws and the Lintons, and their turbulent relationships with Earnshaw's foster son, Heathcliff..", supplier_id: 3)

Product.create!(name: "'The Picture of Dorian Gray' by Oscar Wilde", price: 14.99, description: "The story revolves around a portrait of Dorian Gray painted by Basil Hallward, a friend of Dorian's and an artist infatuated with Dorian's beauty..", supplier_id: 3)
